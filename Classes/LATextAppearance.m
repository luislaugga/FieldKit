...
@implementation LATextAppearance
...
#define kLATextAppearanceCaretWidth 3

+ (CGRect)selectionCaretFrameForTextRect:(CGRect)textRect
{
    return CGRectMake(textRect.origin.x, textRect.origin.y, kLATextAppearanceCaretWidth, textRect.size.height);
}
